...
const Destination = () => {
    return (
        <div className="destination">
            <h1>V.TOUR</h1>
            <h2>Descubre el Mundo desde Casa con V.TOUR: Tu Puerta a Experiencias Inmersivas</h2>
            <p>Bienvenido a V.TOUR, donde la magia de la realidad virtual te invita a explorar los paisajes más impresionantes del mundo sin moverte de tu hogar. Nuestra plataforma ofrece una experiencia inmersiva que te permite conocer destinos extraordinarios de manera sostenible, garantizando que tu viaje no deje huella ni contamine el medio ambiente. Con V.TOUR, cada clic te transporta a maravillas naturales y culturales, brindándote la oportunidad de viajar sin límites y disfrutar de aventuras únicas desde la comodidad de tu sala.</p>
